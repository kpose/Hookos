...
exports.getPost = (request, response) => {
  let postData = {};
  db.doc(`/Hookos/${request.params.postId}`)
    .get()
    .then((doc) => {
      if (!doc.exists) {
...
exports.likePost = (request, response) => {
  ...
  const postDocument = db.doc(`/Hookos/${request.params.postId}`);
...
exports.deletePost = (request, response) => {
  const document = db.doc(`/Hookos/${request.params.postId}`);
  document
    .get()
    .then((doc) => {
      if (!doc.exists) {
